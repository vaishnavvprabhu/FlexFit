...
import com.vgroup.flexfit.activities.HomeExerciseDescActivity;
import com.vgroup.flexfit.data.exercises;

public class homeExerciseAdapter extends FirebaseRecyclerAdapter<exercises, homeExerciseAdapter.exercisesViewholder> {

    //Author : VVP

    public homeExerciseAdapter(
    ...
    protected void onBindViewHolder(@NonNull exercisesViewholder holder, int position, @NonNull exercises model)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), HomeExerciseDescActivity.class);
    ...
    public exercisesViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.exercises_home, parent, false);
        return new homeExerciseAdapter.exercisesViewholder(view);
    }

...
public class breakfastAdapter extends FirebaseRecyclerAdapter<diet, breakfastAdapter.dietViewholder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull breakfastAdapter.dietViewholder holder, int position, @NonNull diet model)
    {
        //Data Entry
    ...
    @NonNull
    @Override
    public breakfastAdapter.dietViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.diet, parent, false);
        return new breakfastAdapter.dietViewholder(view);
    }

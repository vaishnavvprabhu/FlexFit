...
public class dinnerAdapter extends FirebaseRecyclerAdapter<diet, dinnerAdapter.dietViewholder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull dinnerAdapter.dietViewholder holder, int position, @NonNull diet model)
    {
        //Data Entry
    ...
    @NonNull
    @Override
    public dinnerAdapter.dietViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.diet, parent, false);
        return new dinnerAdapter.dietViewholder(view);
    }

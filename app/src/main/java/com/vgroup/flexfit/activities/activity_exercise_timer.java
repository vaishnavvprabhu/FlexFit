...
public class activity_exercise_timer extends AppCompatActivity {
        ...
        exerciseDatabaseReference.orderByChild("name").equalTo(exercisename).addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!snapshot.exists()){
                    ...
                    Intent intent = new Intent(activity_exercise_timer.this, activity_setup.class);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(activity_exercise_timer.this,"Data Error", Toast.LENGTH_SHORT).show();
            }
    ...
    public void notifyUser(String str){
        Toast.makeText(activity_exercise_timer.this,""+str,Toast.LENGTH_LONG).show();
    }
}